    ...
    def parse(self, response):
        for car in response.xpath('//div[@class="cl-list-elements"]'):
            yield {
                ...
                'price': car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-full-item-main"]/div[@class="cldt-summary"]/div[@class="cldt-summary-pricing"]/div[@class="cldt-summary-payment"]/span/text()').extract_first(),
                ...
                'seller': car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-seller"]/div[@clss="cldf-summary-seller-data"]/div[@class="cldf-summary-seller-company"]//div/text()').extract_first(),
