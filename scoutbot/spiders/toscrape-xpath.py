    ...
    def parse(self, response):
        for car in response.xpath('//div[@class="cl-list-elements"]'):
            yield {
                ...
                'price':             car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-full-item-main"]/div[@class="cldt-summary"]/div[@class="cldt-summary-pricing "]//text()').extract_first(),
                ...
                'seller':            car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-seller"]/div[@class="cldt-summary-seller-data"]/div[@class="cldt-summary-seller-company"]//div/text()').extract_first(),
            }
