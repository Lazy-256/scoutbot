...
class ToScrapeSpiderXPath(scrapy.Spider):
    ...
    def parse(self, response):
        for car in response.xpath('//div[@class="cl-list-elements"]'):
            yield {
                # 'example': car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/text()').extract_first(),
                'title': car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-full-item-main"]/div[@class="cldt-summary-headline"]/div[@class="cldt-summary-titles"]/a/div[@class="cldt-summary-title"]/div[@class="cldt-summary-makemodelversion sc-ellipsis"]//h2/text()').extract_first(),
                ...
                'price': car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-full-item-main"]/div[@class="cldt-summary"]/div[@class="cldt-summary-pricing"]/div[@class="cldt-summary-payment"]/span[@data-item-name="price"]//text()').extract_first(),
                ...
                'seller': car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-seller"]/div[@clss="cldf-summary-seller-data"]/div[@class="cldf-summary-seller-company"]/div//div/text()').extract_first(),
