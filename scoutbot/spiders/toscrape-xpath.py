    ...
    def parse(self, response):
        for car in response.xpath('//div[@class="cl-list-elements"]'):
            yield {
                ...
                'title': car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-full-item-main"]/div[@class="cldt-summary-headline"]/div[@class="cldt-summary-titles"]/a[1]/div[@class="cldt-summary-title"]//text()').extract_first(),
                ...
                'price': car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-full-item-main"]/div[@class="cldt-summary"]/div[@class="cldt-summary-pricing"]/div[@class="cldt-summary-payment"]//text()').extract_first(),
                ...
                'seller': car.xpath('./div[@class="cl-list-element cl-list-element-gap"]/div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-seller"]//text()').extract_first(),
