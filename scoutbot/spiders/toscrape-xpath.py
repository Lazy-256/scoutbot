    ...
    def parse(self, response):
        for car in response.xpath('//div[@class="cl-list-element cl-list-element-gap"]'):
            yield {
                ...
                'url':               car.xpath('./div[@class="cldt-summary-full-item"]/div[@class="cldt-summary-full-item-main"]/div[@class="cldt-summary-headline"]/div[@class="cldt-summary-titles"]/a/@href').extract_first(),
